...
const float SPEED       =  2.5f * WORLD_SPACE_SCALE;
...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, float deltaTime)
    {
        ...
        std::cout << direction << " camPosX: " << Position.x << " camPosY: " << Position.y << " camPosZ: " << Position.z << std::endl;
    }
